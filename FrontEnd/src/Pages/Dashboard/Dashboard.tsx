      ...
      <div className={styles.radialChartPlaceholder}>
        ...
        <div className={styles.chartLegend}>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#D9232F" }}></span> Noite
          </div>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#5C5C5C" }}></span> Tarde
          </div>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#212121" }}></span> Manhã
          </div>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#212121" }}></span> 10K
          </div>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#D9232F" }}></span> 4K
          </div>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#212121" }}></span> 2K
          </div>
        </div>
      </div>
    </div>
    ...
    <div className={styles.chartContent}>
      <div className={styles.lineChartPlaceholder}>
        <div className={styles.lineChartLegend}>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#D9232F" }}></span> Comando
            Operacional Metropolitano (COM)
          </div>
          <div className={styles.legendItem}>
            <span style={{ backgroundColor: "#629FEE" }}></span> Comando
            Operacional do Interior /1 (COInter/I)
          </div>
          <div className={styles.legendItem}>
            <span
              className={styles.legendLine}
              style={{ backgroundColor: "#F98C4E" }}
            ></span>{" "}
